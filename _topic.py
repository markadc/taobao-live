...
cookies = {
    "sgcookie": "E100RW7peBGsdrjBVNaKhrIE875dSxYPFRuF3%2BCXydi96sl8w3As55eqo46ebtJrXFQwCWPfIwJuwgA4Q59WPtNYOCGqI88VNou6qkxekYM6aX0%3D",
    "_m_h5_tk": tk,
    "_m_h5_tk_enc": tk_enc,
}
...
topic = jsonp2json(response.text)["data"]["topic"]
print(topic)
